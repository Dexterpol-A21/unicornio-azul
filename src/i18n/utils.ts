...
const ROUTE_MAP: Record<string, Record<Lang, string>> = {
  ...
  route_otras_historias:        { es: '/casos/otras-historias',                en: '/en/case-studies/other-stories' },
  route_caso_padel:             { es: '/casos/otras-historias#smartwatch-padel', en: '/en/case-studies/other-stories#padel-smartwatch' },
