...
export const ui = {
  es: {
    ...
    'nav.caso_roll': 'Roll Order',
    'nav.caso_roll_desc': 'De un documento de patente a producto industrializado y venta en Amazon.',
    'nav.caso_bici': 'Bicicleta eléctrica',
    'nav.caso_bici_desc': 'Sharing urbano, rediseño en Asia y solución arancelaria legal.',
    'nav.caso_utrilla': 'Utrilla',
    'nav.caso_utrilla_desc': 'De fábrica de muebles a solución contract integral en Asia y web.',
    'nav.otras_historias': 'Otras historias',
    'nav.otras_historias_desc': 'SmartWatch Pádel, vehículos y música.',
    'nav.casos_todos': 'Ver todos los casos',
    ...
    'route.casos': '/casos',
    'route.caso_roll': '/casos/roll-order',
    'route.caso_bici': '/casos/bicicleta-electrica',
    'route.caso_utrilla': '/casos/utrilla',
    'route.otras_historias': '/casos/otras-historias',
    'route.caso_padel': '/casos/otras-historias#smartwatch-padel',
  ...
  en: {
    ...
    'nav.caso_roll': 'Roll Order',
    'nav.caso_roll_desc': 'From a patent document to an industrialized product selling on Amazon.',
    'nav.caso_bici': 'Electric bike',
    'nav.caso_bici_desc': 'Urban sharing, Asia redesign, and a legal tariff solution.',
    'nav.caso_utrilla': 'Utrilla',
    'nav.caso_utrilla_desc': 'From a furniture factory to a full contract offer in Asia and web.',
    ...
    'route.caso_roll': '/case-studies/roll-order',
    'route.caso_bici': '/case-studies/electric-bike',
    'route.caso_utrilla': '/case-studies/utrilla',
    'route.otras_historias': '/case-studies/other-stories',
    'route.caso_padel': '/case-studies/other-stories#padel-smartwatch',
